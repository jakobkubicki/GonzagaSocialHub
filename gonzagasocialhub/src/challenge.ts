...
export class challenge {
   ...
   */
  public static currentPanel: challenge
 | undefined;
...
.currentPanel = undefined;
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const styleschallengeUri = webview.asWebviewUri(
        vscode.Uri.joinPath(this._extensionUri, "media", "challengestyle.css")
      );
